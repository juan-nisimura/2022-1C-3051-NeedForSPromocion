...
namespace TGC.Monogame.TP.Src.CompoundObjects.Bullet
{
    public class BulletBodyObject : CylinderObject <BulletBodyObject>
    {
        ...
        public BulletBodyObject()
            : base(new Vector3(0f, BulletObject.BULLET_MODEL_SIZE/2, 0f), new Vector3(BulletObject.BULLET_MODEL_SIZE/2,  BulletObject.BULLET_MODEL_SIZE,  BulletObject.BULLET_MODEL_SIZE/2), MathHelper.PiOver2, 0f, Color.Gold){
        }

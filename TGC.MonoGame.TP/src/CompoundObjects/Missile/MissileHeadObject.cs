...
namespace TGC.Monogame.TP.Src.CompoundObjects.Missile
{
    ...
    {
        private const float MISSILE_HEAD_FORWARD_DISTANCE = 5f;
        private const float MISSILE_DISTANCE_FROM_FLOOR = 10f;
        public MissileHeadObject() :
            base(new Vector3(0f, MissileObject.MISSILE_MODEL_SIZE, MissileObject.MISSILE_MODEL_SIZE/2), new Vector3(0.5f, 1, 0.5f) * MissileObject.MISSILE_MODEL_SIZE, 0f, Color.Red)
        {
        }
